...
class border:
    ...
    border_poss = np.array([["straight_vert", "straight_horiz",
                             ...
                             "horiz_vert_in", "horiz_vert_out",
                             "vert_horiz_up", "vert_horiz_down", "merge_bord"],
                            ["single_line", "│", "─", "┐", "┌", "┘", "└", "├",
                             "┤", "┴", "┬", "┼"],
                            ["double_line", "║", "═", "╗", "╔", "╝", "╚", "╠",
                             "╣", "╩", "╦", "╬"],
        ...
        for p, v in enumerate(obj_list):
            for i, obj in v:
                ...
                if isinstance(obj, multiline_text):
                    ...
                    self.graphics_pos.append((range(p,
                                                    len(
                                                       obj.text.splitlines()
                                                       )
                                                    ),
                                              i))
                    """Multiline text performs a bit differently. The position
                    argument for y has to obtain a range of values."""
